...
from .qt import QMainWindowBase
from .qt import QProgressBar
from .qt import QSize
from .qt import QStackedWidget
from .qt import QStatusBar
...
class MainWindow(QMainWindowBase):
    """단계형 GUI 스켈레톤을 제공한다."""
    ...
    def __init__(self, settings_store: GuiSettingsStore) -> None:
        ...
        self.resize(QSize(920, 500))
        self.setMinimumSize(QSize(760, 400))
        self._build_shell()
